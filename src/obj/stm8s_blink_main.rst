      ...
      008004 CC 80 2D         [ 2]   83 	jp	_main
                                     ...
                                     87 ;--------------------------------------------------------
                                     88 	.area CODE
                                     89 ;	stm8s_blink_main.c: 60: void main(void)
                                     90 ;	-----------------------------------------
                                     91 ;	 function main
                                     92 ;	-----------------------------------------
      00802D                         93 _main:
                                     94 ;	stm8s_blink_main.c: 66: CLK->CKDIVR &= (uint8_t)(~CLK_CKDIVR_HSIDIV);    
      00802D C6 50 C6         [ 1]   95 	ld	a, 0x50c6
      008030 A4 E7            [ 1]   96 	and	a, #0xe7
      008032 C7 50 C6         [ 1]   97 	ld	0x50c6, a
                                     98 ;	stm8s_blink_main.c: 68: CLK->CKDIVR |= (uint8_t)CLK_PRESCALER_HSIDIV1;
      008035 55 50 C6 50 C6   [ 1]   99 	mov	0x50c6, 0x50c6
                                    100 ;	stm8s_blink_main.c: 77: UCOM_LED1_GPIO->ODR &= (uint8_t)(~(UCOM_LED1_PIN)); /* Output mode  Low level */
      00803A 72 1B 50 05      [ 1]  101 	bres	0x5005, #5
                                    102 ;	stm8s_blink_main.c: 78: UCOM_LED1_GPIO->DDR |= (uint8_t)UCOM_LED1_PIN; /* Set Output mode */
      00803E 72 1A 50 07      [ 1]  103 	bset	0x5007, #5
                                    104 ;	stm8s_blink_main.c: 79: UCOM_LED1_GPIO->CR1 |= (uint8_t)UCOM_LED1_PIN; /* Push-Pull */
      008042 72 1A 50 08      [ 1]  105 	bset	0x5008, #5
                                    106 ;	stm8s_blink_main.c: 81: UCOM_LED1_GPIO->CR2 |= (uint8_t)UCOM_LED1_PIN; /* 10MHz */
      008046 72 1A 50 09      [ 1]  107 	bset	0x5009, #5
                                    108 ;	stm8s_blink_main.c: 86: uint32_t vdwDelay = 0;
      00804A 5F               [ 1]  109 	clrw	x
      00804B 90 5F            [ 1]  110 	clrw	y
                                    111 ;	stm8s_blink_main.c: 87: do {
      00804D                        112 00104$:
                                    113 ;	stm8s_blink_main.c: 88: if(vdwDelay)
      00804D 5D               [ 2]  114 	tnzw	x
      00804E 26 04            [ 1]  115 	jrne	00123$
      008050 90 5D            [ 2]  116 	tnzw	y
      008052 27 09            [ 1]  117 	jreq	00102$
      008054                        118 00123$:
                                    119 ;	stm8s_blink_main.c: 90: vdwDelay--;
      008054 1D 00 01         [ 2]  120 	subw	x, #0x0001
      008057 24 F4            [ 1]  121 	jrnc	00104$
      008059 90 5A            [ 2]  122 	decw	y
      00805B 20 F0            [ 2]  123 	jra	00104$
      00805D                        124 00102$:
                                    125 ;	stm8s_blink_main.c: 94: vdwDelay = 0x20000*10;
      00805D 5F               [ 1]  126 	clrw	x
      00805E 90 AE 00 14      [ 2]  127 	ldw	y, #0x0014
                                    128 ;	stm8s_blink_main.c: 96: UCOM_LED1_GPIO->ODR ^= (uint8_t)UCOM_LED1_PIN;
      008062 90 1A 50 05      [ 1]  129 	bcpl	0x5005, #5
                                    130 ;	stm8s_blink_main.c: 98: } while(1);
      008066 20 E5            [ 2]  131 	jra	00104$
                                    132 ;	stm8s_blink_main.c: 100: }
      008068 81               [ 4]  133 	ret
                                    134 	.area CODE
                                    135 	.area CONST
